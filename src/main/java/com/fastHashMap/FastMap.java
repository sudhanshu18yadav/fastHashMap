...
public class FastMap implements Map<Binary, Binary> {
     ...
     */
    public FastMap(int partitionCount) {
     ...
     */
    public FastMap(int partitionCount, Function<byte[], Integer> hashFunction) {
    ...
    private class KeySetIterator implements Iterator<Binary> {
        ...
        private KeySetIterator(FastMap map) {
            this.map = map;
        }
    ...
    private class ValuesIterator implements Iterator<Binary> {
        ...
        private ValuesIterator(FastMap map) {
            this.map = map;
        }
    ...
    private class EntrySetIterator implements Iterator<Entry<Binary, Binary>> {
        ...
        private EntrySetIterator(FastMap map) {
            this.map = map;
        }
